...
public class ThemeSelectFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View foods = view.findViewById(R.id.theme_foods_container);
		...
		final Theme themeFoods = Themes.createFoodsTheme();
		setStars((ImageView) foods.findViewById(R.id.theme_foods), themeFoods, "foods");
		...
		foods.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Shared.eventBus.notify(new ThemeSelectedEvent(themeFoods));
			}
		});
