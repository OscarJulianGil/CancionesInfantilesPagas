...
/**
 * The gateway of all cancionesinfantiles.toycantando.events running in the game from cancionesinfantiles.toycantando.ui to cancionesinfantiles.toycantando.engine components
 * and back.
 * 
 * @author sromku
 */
